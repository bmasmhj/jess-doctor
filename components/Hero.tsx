...
export default function Hero({
  ...
  return (
    <section className="border-b border-line/60 bg-mint/40">
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-12 px-6 pt-16 sm:pt-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        <div className="pb-20">
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-sm font-medium">
            ...
            <span className="rounded-full bg-white px-4 py-2 text-ink">Full adult scope</span>
            <span className="rounded-full bg-white px-4 py-2 text-ink">AHPRA registered</span>
            <span className="rounded-full bg-white px-4 py-2 text-ink">WWCC &amp; insured</span>
          </div>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a
              href="#book"
              className="rounded-full border-2 border-teal-deep px-6 py-3 text-sm font-semibold text-teal-deep transition-colors hover:bg-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-coral"
            >
              Request a booking
            </a>
          </div>
